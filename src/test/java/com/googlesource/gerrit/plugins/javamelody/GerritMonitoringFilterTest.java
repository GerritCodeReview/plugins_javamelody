...
public class GerritMonitoringFilterTest {
  ...
  public void testGroupingPattern() throws Exception {
    ...
    result = GROUPING_PATTERN.matcher("/files/test_dir/under_dir.file/diff").replaceAll(dollar);
    ...
    result =
        GROUPING_PATTERN
            .matcher(
                "/changes/30/revisions/05810c7a315ba6c52c150c237d84d05b2ebc3086/files/test_dir/under_dir.file/diff")
            .replaceAll(dollar);
    assertThat(result)
